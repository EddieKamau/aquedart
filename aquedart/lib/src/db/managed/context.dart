...
import 'package:aquedart/src/application/service_registry.dart';
import 'package:aquedart/src/db/managed/data_model_manager.dart';
...
///
/// You create objects of this type to use the aquedart ORM. Create instances in [ApplicationChannel.prepare]
