...
class Request implements RequestOrResponse {
  ...
  ///
  /// You should typically not manipulate this property's [HttpRequest.response]. By default, aquedart controls
  /// the response through its [Controller]s.
  ///
  /// If you wish to respond to a request manually - and prohibit aquedart from responding to the request - you must
  ...
  ///
  /// Once this method has executed, the [Request] is no longer valid. All headers from [aquedartResponse] are
  /// added to the HTTP response. If [aquedartResponse] has a [Response.body], this request will attempt to encode the body data according to the
  /// Content-Type in the [aquedartResponse]'s [Response.headers].
  ///
