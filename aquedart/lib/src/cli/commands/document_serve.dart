...
import 'package:aquedart/src/cli/mixins/openapi_options.dart';
import 'package:aquedart/src/cli/mixins/project.dart';
import 'package:aquedart/src/cli/running_process.dart';

import 'package:aquedart/src/cli/command.dart';
import 'package:aquedart/src/cli/scripts/openapi_builder.dart';
import 'package:aquedart/src/http/http.dart';
...
class CLIDocumentServe extends CLICommand with CLIProject, CLIDocumentOptions {
  ...
  Directory get _hostedDirectory =>
      Directory.fromUri(projectDirectory!.uri.resolve(".aquedart_spec"));
...
<html>
  ...
  String get detailedDescription {
    return "This tool will start an HTTP server that serves an API reference web page. See `aquedart document --help` for configuration options.";
  }
}
