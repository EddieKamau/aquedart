...
class CLIServer extends CLICommand with CLIProject {
  ...
  @Flag("ipv6-only",
      ...
      negatable: false,
      defaultsTo: false)
  bool? get ipv6Only => decode<bool>("ipv6-only");
  ...
  int? get numberOfIsolates => decode<int>("isolates");
  ...
  Future<StoppableProcess> start() async {
    ...
    final sendPort = await startupCompleter.future
        .timeout(Duration(seconds: startupTimeout ?? 0));
...
import 'package:aquedart/src/cli/starter.dart';
...
Future main(List<String> args, dynamic sendPort) async {
  ...
  String get description {
    return "Runs aquedart applications.";
  }
}
