...
import 'package:aquedart/src/cli/mixins/database_connecting.dart';
import 'package:aquedart/src/cli/mixins/database_managing.dart';
import 'package:aquedart/src/cli/mixins/project.dart';
import 'package:aquedart/src/cli/scripts/run_upgrade.dart';
import 'package:aquedart/src/db/postgresql/postgresql_persistent_store.dart';
import 'package:aquedart/src/db/query/query.dart';
import 'package:aquedart/src/cli/migration_source.dart';
import 'package:aquedart/src/db/schema/schema.dart';
...
class CLIDatabaseUpgrade extends CLICommand
  ...
  Future<int> handle() async {
    ...
    if (migrations.isEmpty) {
      ...
      displayProgress("Run 'aquedart db generate' first.");
      return 0;
    }
