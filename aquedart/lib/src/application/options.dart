...
class ApplicationOptions {
  ...
  ///
  /// This path is provided when an application is started by the `--config-path` option to `aquedart serve`.
  ...
  /// This value is often set through the `--ssl-certificate-path` command line option of `aquedart serve`. For finer control
  ...
  /// This value is often set through the `--ssl-key-path` command line option of `aquedart serve`. For finer control
  /// over how HTTPS is configured for an application, see [ApplicationChannel.securityContext].
