...
///
/// An aquedart application creates instances of this type to pair an HTTP server and an
...
class ApplicationServer {
  ...
  Future didOpen() async {
    server.serverHeader = "aquedart/$identifier";
    ...
    logger.info("Server aquedart/$identifier started.");
  }
