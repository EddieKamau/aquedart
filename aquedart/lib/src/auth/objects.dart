...
///
/// Use the command line tool `aquedart auth` to create instances of this type and store them to a database.
class AuthClient {
...
///
/// An [AuthClient] has a list of valid scopes (see `aquedart auth` tool). An access token issued for an [AuthClient] may ask for
