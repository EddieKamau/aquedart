...
/// implementation like `ManagedAuthDelegate` from `package:aquedart/managed_auth.dart`.
///
...
class AuthServer implements AuthValidator, APIComponentDocumenter {
  ...
  ///
  /// It is preferable to use the implementation of [AuthServerDelegate] from 'package:aquedart/managed_auth.dart'. See
