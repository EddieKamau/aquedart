...
import 'package:aquedart/src/auth/objects.dart';
import 'package:aquedart/src/http/resource_controller.dart';
import 'package:aquedart/src/http/resource_controller_bindings.dart';
import 'package:aquedart/src/http/resource_controller_interfaces.dart';
import 'package:aquedart/src/http/serializable.dart';
import 'package:aquedart/src/openapi/documentable.dart';
import 'package:aquedart/src/openapi/openapi.dart';
import 'package:aquedart/src/runtime/impl.dart';
import 'package:aquedart/src/runtime/resource_controller_impl.dart';
import 'package:aquedart/src/utilities/mirror_helpers.dart';
...
class ResourceControllerDocumenterImpl extends ResourceControllerDocumenter {
  ...
  Map<String, APIOperation> documentOperations(ResourceController rc,
    ...
    final opsForPath = runtime.operations.where((method) =>
        path.containsPathParameters(method.pathVariables as List<String>));
