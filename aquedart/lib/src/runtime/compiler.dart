...
class aquedartCompiler extends Compiler {
  ...
  void deflectPackage(Directory destinationDirectory) {
    ...
    libFile.writeAsStringSync(
      contents.replaceFirst("export 'package:aquedart/src/runtime/compiler.dart';", ""));
  }
  ...
  void didFinishPackageGeneration(BuildContext context) {
    if (context.forTests) {
      ...
      copyDirectory(src: context.sourceApplicationDirectory.uri.resolve("../").resolve("aquedart_test/"), 
      ...
      pubspecContents["dev_dependencies"]["aquedart_test"]["path"] = "packages/aquedart_test";
      pubspecContents["dependency_overrides"]["aquedart"] = pubspecContents["dependencies"]["aquedart"];
