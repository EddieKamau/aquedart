...
You will need a local database for testing, and another database for running the application locally. The behavior and configuration of these databases are documented here: http://aldrinsartfactory.github.io/aqueduct/testing/mixins/.
...
To run your tests with OAuth 2.0 client identifiers, see this documentation: http://aldrinsartfactory.github.io/aqueduct/testing/mixins/#testing-applications-that-use-oauth-20.
...
See the documentation for [Deployment](https://aldrinsartfactory.github.io/aqueduct/deploy/).
